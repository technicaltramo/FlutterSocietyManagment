...
class BuildListViewModeScreen extends GetView<ExpenseReportPerUserController> {
  ...
  Padding _buildMonthYearPaymentDateWidgets(ExpenseReportPerUser report, TextStyle cardTitle) {
    return Padding(
  ...
  Container _buildAmountStatusWidgets(ExpenseReportPerUser report, TextStyle cardTitle) {
    return Container(
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(report.totalAmount.toString(),style: cardTitle,),
                    Text((report.paymentStatus ==1) ? "Paid" : "Due",style: TextStyle(
